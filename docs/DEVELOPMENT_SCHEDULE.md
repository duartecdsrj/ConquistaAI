...
- M0.3: API administrativa, testes e tela Quasar. **Em andamento: criação, listagem paginada e árvore administrativa conectadas; aliases, movimentação e edição pendentes.**
