...
import { CreateTaxonomySubjectAliasUseCase, CreateTaxonomySubjectUseCase, ListTaxonomySubjectsUseCase, UpdateTaxonomySubjectUseCase } from '../Application/Taxonomy/TaxonomyUseCases'
...
export const taxonomyUseCases = { list: new ListTaxonomySubjectsUseCase(taxonomyRepository), create: new CreateTaxonomySubjectUseCase(taxonomyRepository), createAlias: new CreateTaxonomySubjectAliasUseCase(taxonomyRepository), update: new UpdateTaxonomySubjectUseCase(taxonomyRepository) }
