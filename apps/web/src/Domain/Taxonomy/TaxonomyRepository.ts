...
export interface TaxonomyRepository { list(query?:PageQuery):Promise<PageResult<TaxonomySubject>>; create(input:CreateTaxonomySubject):Promise<TaxonomySubject>; createAlias(input:CreateTaxonomySubjectAlias):Promise<TaxonomySubjectAlias> }
