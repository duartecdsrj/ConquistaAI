...
final class Notebook {
 public function __construct(public readonly string $id,public readonly string $userId,public readonly string $name,public readonly NotebookMode $mode,public readonly FrozenQuestionSelection $selection,public readonly \DateTimeImmutable $createdAt,public NotebookStatus $status=NotebookStatus::DRAFT,public ?\DateTimeImmutable $startedAt=null,public ?\DateTimeImmutable $finishedAt=null,public ?int $durationSeconds=null,public readonly array $filters=[]) {}
 public static function create(string $userId,string $name,NotebookMode $mode,FrozenQuestionSelection $selection,\DateTimeImmutable $now,array $filters=[]):self { if(trim($name)==='')throw new \DomainException('Notebook name is required.');return new self(self::uuid(),$userId,trim($name),$mode,$selection,$now,filters:$filters); }
