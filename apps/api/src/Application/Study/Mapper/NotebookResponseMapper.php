...
final class NotebookResponseMapper
{
    public function toResponse(Notebook $notebook): NotebookResponseDto
    {
        return new NotebookResponseDto(
            $notebook->id,
            $notebook->name,
            $notebook->mode->value,
            $notebook->selection->questionIds,
            $notebook->createdAt->format(DATE_ATOM),
